...
export function PeritajePanelDiagram({ panels, onChange, readOnly = false }: { panels: PeritajePanel[]; onChange: (panels: PeritajePanel[]) => void; readOnly?: boolean }) {
  ...
  return (
    <div className="overflow-hidden rounded-md border border-slate-200 bg-white">
      ...
      <div className="grid lg:grid-cols-[minmax(390px,1fr)_minmax(0,0.9fr)]">
        <div className="border-b border-slate-200 bg-slate-50/60 p-3 sm:p-6 lg:border-b-0 lg:border-r">
          <div className="mx-auto grid max-w-[440px] grid-cols-5 grid-rows-5 gap-1.5 rounded-[32px] border-2 border-slate-300 bg-white p-3 shadow-sm sm:gap-2 sm:p-5">
          ...
          <p className="mx-auto mt-3 max-w-[440px] text-center text-xs text-slate-400">Seleccioná una zona para cambiar su estado o agregar una nota.</p>
        </div>
        <div className="p-4">
