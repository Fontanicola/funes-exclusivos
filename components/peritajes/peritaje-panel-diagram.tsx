  ...
  return (
    <div className="overflow-hidden rounded-md border border-slate-200 bg-white">
      ...
      <div className="grid lg:grid-cols-[minmax(390px,1fr)_minmax(0,0.9fr)]">
        <div className="border-b border-slate-200 bg-slate-50/60 p-6 lg:border-b-0 lg:border-r">
          <div className="mx-auto grid max-w-[440px] grid-cols-5 grid-rows-5 gap-2 rounded-[32px] border-2 border-slate-300 bg-white p-5 shadow-sm">
